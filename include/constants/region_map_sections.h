...
//Cornix Customs
#define MAPSEC_ELICIUS_BEACH                0xD5 //unused
#define MAPSEC_VILLA_FLOREA                 0xD6
#define MAPSEC_VIA_FLOREA                   0xD7
#define MAPSEC_ALBION                       0xD8
#define MAPSEC_VIA_ARBUSTA                  0xD9
#define MAPSEC_PORTUS_PRIMUS                0xDA
...
#define MAPSEC_MARE_MORTUORUM               0xE3
#define MAPSEC_ISLA_IGNIFERA                0xE4
#define MAPSEC_ISLA_YERBA_BUENA             0xE5
#define MAPSEC_ISLA_TROPICA                 0xE6
#define MAPSEC_ISLA_PINEA                   0xE7
#define MAPSEC_ISLA_LAVINIA                 0xE8
#define MAPSEC_ISLA_ITHACA                  0xE9
#define MAPSEC_ISLA_SOLATA                  0xEA
#define MAPSEC_ISLA_ARIDA                   0xEB
#define MAPSEC_ACTA_ECHONA                  0xEC
#define MAPSEC_SILVA                        0xED
#define MAPSEC_SILVA_PROFUNDA               0xEE
#define MAPSEC_RIO_DRACO                    0xEF //unused
#define MAPSEC_SALIX                        0xF0
#define MAPSEC_LACUS_DRACUS                 0xF1
#define MAPSEC_LITUS_LACUS                  0xF2
#define MAPSEC_DRACUS_SUPERIOR              0xF3
#define MAPSEC_DRACUS_INFERIOR              0xF4
#define MAPSEC_UPPER_EAST_DRAKE             0xF5
#define MAPSEC_LOWER_EAST_DRAKE             0xF6
#define MAPSEC_UPPER_WEST_DRAKE             0xF7
#define MAPSEC_LOWER_WEST_DRAKE             0xF8
