...
enum __attribute__((packed)) Item
{
	...
	ITEM_TRIVIS_SHARD5                = 881,
	ITEM_TRIVIS_SHARD6                = 882,
	ITEM_TRIVIS_SHARD7                = 883,
	ITEM_TRIVIS_SHARD8                = 884,
	ITEM_TRIVIS_MAP                   = 885,
	ITEM_FISHING_ROD                  = 886,
	ITEM_FISHING_BAIT                 = 887,
	ITEM_FISHING_LURE                 = 888,
	ITEM_LIVE_BAIT                    = 889,
	ITEM_LIVE_BAIT_TOOLS              = 890,
	ITEM_PINA_FRUIT                   = 891,
	ITEM_LOTUS_LEAF                   = 892,
	ITEM_INSURANCE_FORM_A             = 893,
	ITEM_INSURANCE_FORM_B             = 894,
	ITEM_INSURANCE_CARD               = 895,
	ITEM_DEATH_STICK                  = 896,
	ITEM_TATTOO                       = 897,
	ITEM_DIPLOMA                      = 898,
	ITEM_KEG                          = 899,
	ITEM_ANCIENT_LAMP                 = 900,
	ITEM_BOOK                         = 901,
	ITEM_WEDDING_INVITATION_HECTOR    = 902,
	ITEM_TRIVIS_POTESTATIS            = 903,       
	ITEM_BIG_HAMMER                   = 904,
	ITEM_OSTRACON                     = 905,
	ITEM_COLCHIS_KEY                  = 906,
	ITEM_COLCHIS_RING                 = 907,
	ITEM_COLCHIS_APPLE                = 908,
	ITEM_COLCHIS_JAIL_KEY             = 909,
	ITEM_WEDDING_INVITATION_AENEAS    = 910,
	ITEM_WEDDING_INVITATION_AGAMEMNON = 911,
	ITEM_WEDDING_INVITATION_ULYSSES   = 912,
	ITEM_SURFBOARD                    = 913,
	ITEM_TRAINER_CARD                 = 914,
	ITEM_SCYTHE                       = 915,
	ITEM_MEWRA_SIGIL                  = 916,
	ITEM_FLASHLIGHT                   = 917,
	ITEM_PENELOPE_RING                = 918,
