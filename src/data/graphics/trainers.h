...
const struct TrainerSprite gTrainerSprites[] =
{
	...
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BLUE1, gTrainerFrontPic_Blue1, gTrainerPalette_Blue1),                  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_LORELEI, gTrainerFrontPic_Lorelei, gTrainerPalette_Lorelei),              
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BLAINE, gTrainerFrontPic_Blaine, gTrainerPalette_Blaine),               
	TRAINER_SPRITE(TRAINER_PIC_FRONT_JESSEANDJAMES, gTrainerFrontPic_JesseAndJames, gTrainerPalette_JesseAndJames),         
	TRAINER_SPRITE(TRAINER_PIC_FRONT_SUPER_NERD, gTrainerFrontPic_SuperNerd, gTrainerPalette_SuperNerd),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_AROMA_LADY2, gTrainerFrontPic_AromaLady2, gTrainerPalette_AromaLady2),    	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIKER, gTrainerFrontPic_Biker, gTrainerPalette_Biker),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIRD_KEEPER2, gTrainerFrontPic_BirdKeeper2, gTrainerPalette_BirdKeeper2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BEAUTY2, gTrainerFrontPic_Beauty2, gTrainerPalette_Beauty2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BLACK_BELT2, gTrainerFrontPic_BlackBelt2, gTrainerPalette_BlackBelt2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BURGLAR, gTrainerFrontPic_Burglar, gTrainerPalette_Burglar),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_CAMPER2, gTrainerFrontPic_Camper2, gTrainerPalette_Camper2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BLUE2, gTrainerFrontPic_Blue2, gTrainerPalette_Blue2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BLUE3, gTrainerFrontPic_Blue3, gTrainerPalette_Blue3),  
	...
	TRAINER_SPRITE(TRAINER_PIC_FRONT_AGATHA, gTrainerFrontPic_Agatha, gTrainerPalette_Agatha),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BRUNO, gTrainerFrontPic_Bruno, gTrainerPalette_Bruno),  
	...
	TRAINER_SPRITE(TRAINER_PIC_FRONT_GAMER, gTrainerFrontPic_Gamer, gTrainerPalette_Gamer),      
	TRAINER_SPRITE(TRAINER_PIC_FRONT_GENTLEMAN2, gTrainerFrontPic_Gentleman2, gTrainerPalette_Gentleman2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_HIKER2, gTrainerFrontPic_Hiker2, gTrainerPalette_Hiker2),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_JUGGLER, gTrainerFrontPic_Juggler, gTrainerPalette_Juggler),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_LADY2, gTrainerFrontPic_Lady2, gTrainerPalette_Lady2),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_LASS2, gTrainerFrontPic_Lass2, gTrainerPalette_Lass2),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BROCK, gTrainerFrontPic_Brock, gTrainerPalette_Brock),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_ERIKA, gTrainerFrontPic_Erika, gTrainerPalette_Erika),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_GIOVANNI, gTrainerFrontPic_Giovanni, gTrainerPalette_Giovanni),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_KOGA, gTrainerFrontPic_Koga, gTrainerPalette_Koga),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_LT_SURGE, gTrainerFrontPic_LtSurge, gTrainerPalette_LtSurge),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_MISTY, gTrainerFrontPic_Misty, gTrainerPalette_Misty),      
	TRAINER_SPRITE(TRAINER_PIC_FRONT_SABRINA, gTrainerFrontPic_Sabrina, gTrainerPalette_Sabrina),      
	TRAINER_SPRITE(TRAINER_PIC_FRONT_PAINTER, gTrainerFrontPic_Painter, gTrainerPalette_Painter),      	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_PICNICKER2, gTrainerFrontPic_Picnicker2, gTrainerPalette_Picnicker2),      	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_POKEMANIAC2, gTrainerFrontPic_Pokemaniac2, gTrainerPalette_Pokemaniac2),      	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_POKEMON_BREEDER_F2, gTrainerFrontPic_PokemonBreederF2, gTrainerPalette_PokemonBreederF2),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_PROFESSOR_OAK, gTrainerFrontPic_ProfessorOak, gTrainerPalette_ProfessorOak),  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_PSYCHIC_M2, gTrainerFrontPic_PsychicM2, gTrainerPalette_PsychicF2),  	  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_PSYCHIC_F2, gTrainerFrontPic_PsychicF2, gTrainerPalette_PsychicM2),  	  	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_ROCKER, gTrainerFrontPic_Rocker, gTrainerPalette_Rocker),  	    	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_RUIN_MANIAC2, gTrainerFrontPic_RuinManiac2, gTrainerPalette_RuinManiac2),  	      
	TRAINER_SPRITE(TRAINER_PIC_FRONT_SAILOR2, gTrainerFrontPic_Sailor2, gTrainerPalette_Sailor2),  	          
	...
	TRAINER_SPRITE(TRAINER_PIC_FRONT_YOUNGSTER2, gTrainerFrontPic_Youngster2, gTrainerPalette_Youngster2),          
	TRAINER_SPRITE(TRAINER_PIC_FRONT_MEWTWOARMOR, gTrainerFrontPic_MewtwoArmor, gTrainerPalette_MewtwoArmor),          
	TRAINER_SPRITE(TRAINER_PIC_FRONT_SOLDIER, gTrainerFrontPic_Soldier, gTrainerPalette_Soldier),  	          
	TRAINER_SPRITE(TRAINER_PIC_FRONT_MISTY2, gTrainerFrontPic_Misty2, gTrainerPalette_Misty2),                
	TRAINER_SPRITE(TRAINER_PIC_FRONT_JANITOR, gTrainerFrontPic_Janitor, gTrainerPalette_Janitor),               
	TRAINER_SPRITE(TRAINER_PIC_FRONT_NURSE_JOY, gTrainerFrontPic_NurseJoy, gTrainerPalette_NurseJoy),             
	TRAINER_SPRITE(TRAINER_PIC_FRONT_CUE_BALL_NO_BIKE, gTrainerFrontPic_CueBallNoBike, gTrainerPalette_CueBallNoBike),  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_GREEN, gTrainerFrontPic_Green, gTrainerPalette_Green),            	  
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIG_BLUE, gTrainerFrontPic_BigBlue, gTrainerPalette_BigBlue),              
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIG_YELLOW, gTrainerFrontPic_BigYellow, gTrainerPalette_BigYellow),            
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIG_GREEN, gTrainerFrontPic_BigGreen, gTrainerPalette_BigGreen),             
	TRAINER_SPRITE(TRAINER_PIC_FRONT_BIG_RED, gTrainerFrontPic_BigRed, gTrainerPalette_BigRed),     
	TRAINER_SPRITE(TRAINER_PIC_FRONT_KANDO, gTrainerFrontPic_Kando, gTrainerPalette_Kando),               
	TRAINER_SPRITE(TRAINER_PIC_FRONT_ROOD, gTrainerFrontPic_Rood, gTrainerPalette_Rood),               
	...
	TRAINER_SPRITE(TRAINER_PIC_FRONT_FARMER_M, gTrainerFrontPic_Farmer_M, gTrainerPalette_Farmer_M),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BILL, gTrainerFrontPic_Bill, gTrainerPalette_Bill),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SORDWARD_SHIELBERT, gTrainerFrontPic_Sordward_Shielbert, gTrainerPalette_Sordward_Shielbert),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PETREL, gTrainerFrontPic_Petrel, gTrainerPalette_Petrel),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ORPHEUS, gTrainerFrontPic_Orpheus, gTrainerPalette_Orpheus),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PHIL, gTrainerFrontPic_Phil, gTrainerPalette_Phil),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_THESEUS, gTrainerFrontPic_Theseus, gTrainerPalette_Theseus),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_NESTOR, gTrainerFrontPic_Nestor, gTrainerPalette_Nestor),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_HELEN, gTrainerFrontPic_Helen, gTrainerPalette_Helen),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PARIS, gTrainerFrontPic_Paris, gTrainerPalette_Paris),               
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_KLYTAIMNESTRA, gTrainerFrontPic_Klytaimnestra, gTrainerPalette_Sage),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LUCY, gTrainerFrontPic_Lucy, gTrainerPalette_Lucy),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_AGAMEMNON, gTrainerFrontPic_Agamemnon, gTrainerPalette_Agamemnon),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_CLAIRE, gTrainerFrontPic_Claire, gTrainerPalette_Claire),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_WALLACE2, gTrainerFrontPic_Wallace2, gTrainerPalette_Wallace2),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_CHUCK, gTrainerFrontPic_Chuck, gTrainerPalette_Chuck),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_AVERY, gTrainerFrontPic_Avery, gTrainerPalette_Avery),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MOHN, gTrainerFrontPic_Mohn, gTrainerPalette_Mohn),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_TEUCER, gTrainerFrontPic_Teucer, gTrainerPalette_Teucer),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BLAINE2, gTrainerFrontPic_Blaine2, gTrainerPalette_Blaine2),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LEON, gTrainerFrontPic_Leon, gTrainerPalette_Leon),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_JOCASTA, gTrainerFrontPic_Jocasta, gTrainerPalette_Jocasta),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_AMAZON, gTrainerFrontPic_Amazon, gTrainerPalette_Amazon),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_HIPPOLYTA, gTrainerFrontPic_Hippolyta, gTrainerPalette_Hippolyta),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_TROJAN, gTrainerFrontPic_Trojan, gTrainerPalette_Trojan),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_TROILUS, gTrainerFrontPic_Troilus, gTrainerPalette_Troilus),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_CRESSIDA, gTrainerFrontPic_Cressida, gTrainerPalette_Cressida),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_KIMONO_GIRL, gTrainerFrontPic_Kimono_Girl, gTrainerPalette_Kimono_Girl),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PRIAM, gTrainerFrontPic_Priam, gTrainerPalette_Priam),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_KAREN, gTrainerFrontPic_Karen, gTrainerPalette_Karen),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_DRAYDEN, gTrainerFrontPic_Drayden, gTrainerPalette_Drayden),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GHETSIS, gTrainerFrontPic_Ghetsis, gTrainerPalette_Ghetsis),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_OLYMPIA, gTrainerFrontPic_Olympia, gTrainerPalette_Olympia),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LINK, gTrainerFrontPic_Link, gTrainerPalette_Link),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GANONDORF, gTrainerFrontPic_Ganondorf, gTrainerPalette_Ganondorf),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SHEIK, gTrainerFrontPic_Sheik, gTrainerPalette_Sheik),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ZELDA, gTrainerFrontPic_Zelda, gTrainerPalette_Zelda),               
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MOM, gTrainerFrontPic_Mom, gTrainerPalette_Mom),               
