...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_TANOBY_CHAMBERS] =              MAPPOPUP_THEME_BRICK, 
	[MAPSEC_THREE_ISLE_PATH] =              MAPPOPUP_THEME_BRICK, 
	[MAPSEC_TANOBY_KEY] =                   MAPPOPUP_THEME_BRICK, 
	[MAPSEC_BIRTH_ISLAND_FRLG] =            MAPPOPUP_THEME_BRICK, 
	[MAPSEC_MONEAN_CHAMBER] =               MAPPOPUP_THEME_BRICK, 
	...
	[MAPSEC_RIXY_CHAMBER] =                 MAPPOPUP_THEME_BRICK, 
