...
#include "event_data.h" //Cornix FlagGet()
#include "event_scripts.h" //cornix for treasure scripts
...
//static bool32 DoesFishingMinigameAllowCancel(void); Cornix Custom Fishing
