...
enum __attribute__((packed)) Item
{
	...
	//Customs
	ITEM_INSURANCE_FORM_A             = 874,
	ITEM_INSURANCE_FORM_B             = 875,
	ITEM_INSURANCE_CARD               = 876,
	ITEM_DEATH_STICK                  = 877,
	ITEM_TATTOO                       = 878,
	ITEM_DIPLOMA                      = 879,
	ITEM_KEG                          = 880,
	ITEM_ANCIENT_LAMP                 = 881,
	ITEM_BOOK                         = 882,
	ITEM_WEDDING_INVITATION_HECTOR    = 883,
	ITEM_TRIVIS_POTESTATIS            = 884,
	ITEM_BIG_HAMMER                   = 885,
	ITEM_OSTRACON                     = 886,
	ITEM_COLCHIS_KEY                  = 887,
	ITEM_COLCHIS_RING                 = 888,
	ITEM_COLCHIS_APPLE                = 889,
	ITEM_COLCHIS_JAIL_KEY             = 890,
	ITEM_WEDDING_INVITATION_AENEAS    = 891,
	ITEM_WEDDING_INVITATION_AGAMEMNON = 892,
	ITEM_WEDDING_INVITATION_ULYSSES   = 893,
	ITEM_SURFBOARD                    = 894,
	ITEM_TRAINER_CARD                 = 895,
	ITEM_SCYTHE                       = 896,
	ITEM_MEWRA_SIGIL                  = 897,
	ITEM_FLASHLIGHT                   = 898,
	ITEM_PENELOPE_RING                = 899,
	ITEM_LOTUS_LEAF                   = 900,
	//End Customs
