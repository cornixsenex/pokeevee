...
enum TrainerClassID
{
	...
	TRAINER_CLASS_FUCKBOY,
    TRAINER_CLASS_PKMN_TEACHER,
    TRAINER_CLASS_PKMN_SCIENTIST,
    TRAINER_CLASS_ROCKET_BOSS,
    TRAINER_CLASS_JANITOR,
    TRAINER_CLASS_NURSE,
    TRAINER_CLASS_DOCTOR,
    TRAINER_CLASS_CULTIST,
    TRAINER_CLASS_SURF_SCHOOL,
    TRAINER_CLASS_SURFER,
    TRAINER_CLASS_TYRIAN,
    TRAINER_CLASS_TYRIAN_QUEEN,
    TRAINER_CLASS_TROPIC_SLAVE,
    TRAINER_CLASS_RUTULIAN,
    TRAINER_CLASS_DARK_SHADOW,
    TRAINER_CLASS_SILENT_HERO,
    TRAINER_CLASS_GERUDO_KING,
    TRAINER_CLASS_PRINCESS,
    TRAINER_CLASS_MYSTERIOUS,
    TRAINER_CLASS_ENCHANTRESS,
    TRAINER_CLASS_LOTUS,
    TRAINER_CLASS_FRUIT_FAN,
    TRAINER_CLASS_BRAVE,
	TRAINER_CLASS_LEAF,
