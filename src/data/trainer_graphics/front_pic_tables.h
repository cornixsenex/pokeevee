...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
	...
	TRAINER_SPRITE(GENTLEMAN2, gTrainerFrontPic_Gentleman2, 0x800),
	TRAINER_SPRITE(HIKER2, gTrainerFrontPic_Hiker2, 0x800),
	TRAINER_SPRITE(JUGGLER, gTrainerFrontPic_Juggler, 0x800),
	TRAINER_SPRITE(LADY2, gTrainerFrontPic_Lady2, 0x800),
	TRAINER_SPRITE(LASS2, gTrainerFrontPic_Lass2, 0x800),
	...
	TRAINER_SPRITE(JANITOR, gTrainerFrontPic_Janitor, 0x800),
	TRAINER_SPRITE(NURSE_JOY, gTrainerFrontPic_Nurse_Joy, 0x800),
  	...
  	TRAINER_SPRITE(BIG_GREEN, gTrainerFrontPic_BigGreen, 0x800),
  	TRAINER_SPRITE(BIG_RED, gTrainerFrontPic_BigRed, 0x800),
