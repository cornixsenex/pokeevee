...
#define OW_ALTERED_TIME_RATIO           GEN_5   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. TIME_DEBUG is 1:1, and meant for debugging purposes. This has no effect if OW_USE_FAKE_RTC is FALSE. NOTE: GEN_5 is CORNIX CUSTOM value
...
#define OW_FLAG_NO_ENCOUNTER        0x4E  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      0x4F  // If this flag is set, trainers will not battle the player unless they're talked to.
