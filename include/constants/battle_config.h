...
// Damage settings
#define B_BURN_DAMAGE               GEN_4 // In Gen7+, burn damage is 1/16th of max HP instead of 1/8th.
...
#define B_RECALC_TURN_AFTER_ACTIONS GEN_4 // In Gen8, switching/using a move affects the current turn's order of actions.
...
// Move data settings
#define B_UPDATED_MOVE_DATA         GEN_4 // Updates move data in gBattleMoves, including Power, Accuracy, PP, stat changes, targets and chances of secondary effects.
...
// Other move settings
#define B_SOUND_SUBSTITUTE          GEN_4 // In Gen6+, sound moves bypass Substitute.
...
#define B_SYNCHRONIZE_NATURE        GEN_5 // In Gen8, if a Pokémon with Synchronize is leading the party, it's 100% guaranteed that wild Pokémon will have the same ability, as opposed to 50% previously.
...
#define B_SOUL_DEW_BOOST            GEN_4 // In Gens3-6, Soul Dew boosts Lati@s' Sp. Atk and Sp. Def. In Gen7+ it boosts the power of their Psychic and Dragon type moves instead.
