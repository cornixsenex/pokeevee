...
extern const u8 EventScript_UseFlash_Vanilla[];
...
extern const u8 Script_Tombstone_Tolstoy[];
extern const u8 Script_Tombstone_Pope[];
extern const u8 Script_Tombstone_HunterThompson[];
extern const u8 Script_Tombstone_Kesey[];
extern const u8 Script_Tombstone_MilesDavis[];
extern const u8 Script_Tombstone_Coltrane[];
extern const u8 Script_Tombstone_Dante[];
extern const u8 Script_Tombstone_Chaucer[];
extern const u8 Script_Tombstone_Tchaikovsky[];
extern const u8 Script_Tombstone_Montesquieu[];
extern const u8 Script_Tombstone_Rousseau[];
extern const u8 Script_Tombstone_Paine[];
extern const u8 Script_Tombstone_Elvis[];
extern const u8 Script_Tombstone_Ovid[];
extern const u8 Script_Tombstone_Tacitus[];
extern const u8 Script_Tombstone_CatoMinor[];
extern const u8 Script_Tombstone_Bohr[];
extern const u8 Script_Tombstone_Descartes[];
extern const u8 Script_Tombstone_Aristophanes[];
extern const u8 Script_Tombstone_Hemingway[];
extern const u8 Script_Tombstone_Ginsberg[];
extern const u8 Script_Tombstone_VonNeumann[];
extern const u8 Script_Tombstone_Edison[];
extern const u8 Script_Tombstone_Vanderbilt[];
extern const u8 Script_Tombstone_Leonidas[];
extern const u8 Script_Tombstone_Pompey[];
extern const u8 Script_Tombstone_Pericles[];
extern const u8 Script_Tombstone_Antigonos[];
extern const u8 Script_Tombstone_Darius[];
extern const u8 Script_Tombstone_Spartacus[];
extern const u8 Script_Tombstone_Otto[];
extern const u8 Script_Tombstone_Justinian[];
...
extern const u8 Script_Tombstone_Richard2[];
...
extern const u8 Script_Tombstone_Jobs[];
extern const u8 Script_Tombstone_Cobain[];
extern const u8 Script_Tombstone_Michelangelo[];
extern const u8 Script_Tombstone_Copernicus[];
extern const u8 Script_Tombstone_Galileo[];
extern const u8 Script_Tombstone_Cash[];
extern const u8 Script_Tombstone_Freud[];
extern const u8 Script_Tombstone_Kant[];
extern const u8 Script_Tombstone_Diogenes[];
extern const u8 Script_Tombstone_Cervantes[];
extern const u8 Script_Tombstone_Kerouac[];
...
//Route10CS
extern const u8 Route10CS_Script_Transition_ActaTranquilla[]; 
extern const u8 Route10CS_Script_Transition_MareTranquillum[];
//MareS6
...
//MareS2
extern const u8 MareS2_Script_Transition_MareTranquillum[];
...
//BigIslandS
extern const u8 BigIslandS_Script_Transition_MareOriens[];
...
//MareS7
extern const u8 MareS7_Script_Transition_IslaArida[];
extern const u8 MareS7_Script_Transition_MareSubtropicum[];
extern const u8 MareS7_Script_Transition_IslaHerbaBona[];
extern const u8 MareS7_Script_Transition_IslaIthaca[];
//MareS8
extern const u8 MareS8_Script_Transition_IslaIthaca[];
...
extern const u8 AedesTerra_Script_UnSolvedPuzzle1[];
extern const u8 AedesTerra_Script_SolvedPuzzle2[];
extern const u8 AedesTerra_Script_SolvedPuzzle3[];
extern const u8 AedesTerra_Script_UnSolvedPuzzle3[];
extern const u8 AedesTerra_Script_SolvedPuzzle4[];
