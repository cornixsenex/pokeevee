...
const struct CompressedSpritePalette gBallSpritePalettes[POKEBALL_COUNT] =
{
    ...
    [BALL_LEVEL]   = {gInterfaceGfx_LevelBall,   GFX_TAG_LEVELBALL},
    [BALL_LURE]    = {gInterfaceGfx_LureBall,    GFX_TAG_LUREBALL},
    [BALL_MOON]    = {gInterfaceGfx_MoonBall,    GFX_TAG_MOONBALL},
    [BALL_FRIEND]  = {gInterfaceGfx_FriendBall,  GFX_TAG_FRIENDBALL},
    [BALL_LOVE]    = {gInterfaceGfx_LoveBall,    GFX_TAG_LOVEBALL},
    [BALL_HEAVY]   = {gInterfaceGfx_HeavyBall,   GFX_TAG_HEAVYBALL},
    [BALL_FAST]    = {gInterfaceGfx_FastBall,    GFX_TAG_FASTBALL},
	[BALL_SPORT]   = {gInterfaceGfx_SportBall,   GFX_TAG_SPORTBALL},
	[BALL_DUSK]    = {gInterfaceGfx_DuskBall,    GFX_TAG_DUSKBALL},
	[BALL_QUICK]   = {gInterfaceGfx_QuickBall,   GFX_TAG_QUICKBALL},
	[BALL_HEAL]    = {gInterfaceGfx_HealBall,    GFX_TAG_HEALBALL},
