static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CITY_CLARA - 1] = {MAP_GROUP(CITY_CLARA), MAP_NUM(CITY_CLARA), 10, 0},
    [HEAL_LOCATION_ELICIUS_BEACH - 1] = {MAP_GROUP(ELICIUS_BEACH), MAP_NUM(ELICIUS_BEACH), 0, 0},
    [HEAL_LOCATION_GATO_CITY - 1] = {MAP_GROUP(GATO_CITY), MAP_NUM(GATO_CITY), 0, -2},
    ...
    [HEAL_LOCATION_GATO_CITY_N - 1] = {MAP_GROUP(GATO_CITY_N), MAP_NUM(GATO_CITY_N), -1, 0},
