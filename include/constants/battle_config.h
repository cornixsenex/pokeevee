...
#define B_RECOIL_IF_MISS_DMG        GEN_4 // In Gen5+, Jump Kick and Hi Jump Kick will always do half of the user's max HP when missing.
...
#define B_GHOSTS_ESCAPE             GEN_4 // In Gen6+, ghosts can escape even when blocked by abilities such as Shadow Tag.
...
#define B_STEEL_RESISTANCES         GEN_4 // In Gen6+, Steel-type Pokémon are no longer resistant to Dark and Ghost moves.
