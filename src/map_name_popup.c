...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	//Cornix Customs
    [MAPSEC_ELICIUS_BEACH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VILLA_FLORA   - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VIA_FLORAE - KANTO_MAPSEC_COUNT]    = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MARE_TROPICUS - KANTO_MAPSEC_COUNT]       = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_MARE_SUBTROPICUS - KANTO_MAPSEC_COUNT]    = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_MARE_MALUS - KANTO_MAPSEC_COUNT]          = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ISLA_IGNIFERA - KANTO_MAPSEC_COUNT]       = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_YERBA_BUENA - KANTO_MAPSEC_COUNT]    = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_TROPICANA - KANTO_MAPSEC_COUNT]      = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_PINA - KANTO_MAPSEC_COUNT]           = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_LAVINIA - KANTO_MAPSEC_COUNT]        = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_UPPER_RIO_DRACO - KANTO_MAPSEC_COUNT]     = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_LOWER_RIO_DRACO - KANTO_MAPSEC_COUNT]     = MAPPOPUP_THEME_MARBLE,
