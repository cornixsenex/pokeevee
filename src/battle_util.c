...
//I have altered this function to enable Mew and Deoxys to obey player (pray I don't alter it any further)
...
//Function disabled to remove obedience stuff.
u8 IsMonDisobedient(void)
{
//    if (gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK))
//        return 0;
//    if (BattlerHasAi(gBattlerAttacker))Function disabled to remove obedience stuff.
//        return 0;
//
