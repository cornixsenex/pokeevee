static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GATO_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    ...
    [HEAL_LOCATION_GATO_CITY_N - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    [HEAL_LOCATION_GATO_CITY_S - 1] = {MAP_GROUP(GATO_CITY_S), MAP_NUM(GATO_CITY_S), 14, 5},
