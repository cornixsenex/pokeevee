...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_MAROWAK_ALOLAN}},
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                       ...
                                       {EVO_ITEM, ITEM_WHIPPED_DREAM, SPECIES_SYLVEON}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 37, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_LEVEL, 37, SPECIES_GOURGEIST}},
    ...
    [SPECIES_RATTATA_ALOLAN]        = {{EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_RATICATE_ALOLAN}},
    [SPECIES_SANDSHREW_ALOLAN]      = {{EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_SANDSLASH_ALOLAN}},
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_NINETALES_ALOLAN}},
    [SPECIES_DIGLETT_ALOLAN]        = {{EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_DUGTRIO_ALOLAN}},
    [SPECIES_MEOWTH_ALOLAN]         = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_PERSIAN_ALOLAN}},
    [SPECIES_GEODUDE_ALOLAN]        = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_GRAVELER_ALOLAN}},
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_GRIMER_ALOLAN]         = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_MUK_ALOLAN}},
    [SPECIES_MEOWTH_GALARIAN]       = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_PERRSERKER}},
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_RAPIDASH_GALARIAN}},
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_ITEM, ITEM_MEWTWONITE_X, SPECIES_SLOWBRO_GALARIAN},
                                       {EVO_ITEM, ITEM_MEWTWONITE_Y, SPECIES_SLOWKING_GALARIAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 37, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 37, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 37, SPECIES_GOURGEIST_SUPER}},
