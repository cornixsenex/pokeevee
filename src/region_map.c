		...
		if (mapGroup == MAP_GROUP(MAP_MARE_S5) && mapNum == MAP_NUM(MAP_MARE_S5))
		{
			...
			switch (n)
			{
				...
				case 3:
					return StringCopy(dest, COMPOUND_STRING("ISLA PINEA"));
				case 4:
					return StringCopy(dest, COMPOUND_STRING("SIRENVM SCOPVLI"));
				default:
					return StringCopy(dest, gText_Ferry);
            }
        }
...
u32 GetDynamicMapSec_Route17(bool32 useWarpInfo)
{
	...
	//Upper Rio Draco = 3
			...
			( (x == 14) && ( (y > 26) && (y < 32) ) ) ||
			( (x == 15) && ( (y > 26) && (y < 31) ) ) ||
			( (x == 16) && ( ( (y > 25) && (y < 31) ) || ( (y > 33) && (y < 52) ) ) ) ||  //Up and Down  
			( (x == 17) && ( ( (y > 24) && (y < 31) ) || ( (y > 32) && (y < 53) ) ) ) ||  //Up and Down  
			( (x == 18) && ( ( (y > 23) && (y < 30) ) || ( (y > 32) && (y < 53) ) ) ) ||  //Up and Down  
