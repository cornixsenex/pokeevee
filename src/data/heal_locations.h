static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GRANDMAS_CABIN - 1] = {MAP_GROUP(GRANDMAS_CABIN), MAP_NUM(GRANDMAS_CABIN), 10, 10},
    [HEAL_LOCATION_CITY_CLARA - 1] = {MAP_GROUP(CITY_CLARA), MAP_NUM(CITY_CLARA), 20, 31},
    [HEAL_LOCATION_ELICIUS_BEACH - 1] = {MAP_GROUP(ELICIUS_BEACH), MAP_NUM(ELICIUS_BEACH), 0, 0},
    [HEAL_LOCATION_GATO_CITY - 1] = {MAP_GROUP(GATO_CITY), MAP_NUM(GATO_CITY), 0, 0},
    [HEAL_LOCATION_GATO_CITY_DT - 1] = {MAP_GROUP(GATO_CITY_DT), MAP_NUM(GATO_CITY_DT), 0, 0},
    [HEAL_LOCATION_GATO_CITY_E - 1] = {MAP_GROUP(GATO_CITY_E), MAP_NUM(GATO_CITY_E), 0, 0},
    [HEAL_LOCATION_GATO_CITY_N - 1] = {MAP_GROUP(GATO_CITY_N), MAP_NUM(GATO_CITY_N), 0, 0},
    [HEAL_LOCATION_GATO_CITY_S - 1] = {MAP_GROUP(GATO_CITY_S), MAP_NUM(GATO_CITY_S), 0, 0},
    [HEAL_LOCATION_SLABS - 1] = {MAP_GROUP(SLABS), MAP_NUM(SLABS), 0, 0},
    [HEAL_LOCATION_PHOENIX - 1] = {MAP_GROUP(PHOENIX), MAP_NUM(PHOENIX), 0, 0},
    [HEAL_LOCATION_VEGAS - 1] = {MAP_GROUP(VEGAS), MAP_NUM(VEGAS), 0, 0},
    [HEAL_LOCATION_WILLOW - 1] = {MAP_GROUP(WILLOW), MAP_NUM(WILLOW), 0, 0},
};
