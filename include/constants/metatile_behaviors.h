...
enum {
    ...
    MB_SAND,
    MB_SEAWEED,
    MB_TOMBSTONE, //For Mortia tombstones
    MB_ASHGRASS,
    MB_FOOTPRINTS,
    MB_THIN_ICE,
    MB_CRACKED_ICE,
    ...
    MB_CYCLING_ROAD_PULL_DOWN, //CYCLING ROAD
    MB_CYCLING_ROAD_PULL_UP,   //CYCLING ROAD
    MB_CYCLING_ROAD_PULL_LEFT, //CYCLING ROAD
    MB_CYCLING_ROAD_PULL_RIGHT,//CYCLING ROAD
    MB_IMPASSABLE_EAST,
    MB_IMPASSABLE_WEST,
    MB_IMPASSABLE_NORTH,
    MB_IMPASSABLE_SOUTH,
    ...
    MB_SPIN_RIGHT, //SPIN TILES
    MB_SPIN_LEFT,  //SPIN TILES
    MB_SPIN_UP,    //SPIN TILES
    MB_SPIN_DOWN,  //SPIN TILES
    MB_STOP_SPINNING,
    MB_UNUSED_59,
    MB_UNUSED_5A,
    MB_UNUSED_5B,
    ...
    MB_COUNTER,
    MB_CYCLING_ROAD_BRIDGE_PULL_RIGHT, //CYCLING ROAD
    MB_CYCLING_ROAD_BRIDGE_PULL_LEFT,  //CYCLING ROAD
    MB_PC,
    ...
    MB_FALSE_FLOOR,      //FALSE FLOOR IGNIS MONS
    MB_FALSE_FLOOR_HOLE, //FALSE FLOOR IGNIS MONS
    MB_BERRY_TREE_SOIL,
    MB_UNUSED_A1,
    MB_UNUSED_A2,
    MB_UNUSED_A3,
    ...
    MB_COLCHIS_BATTLE, //AUTO BATTLE COLCHIS
